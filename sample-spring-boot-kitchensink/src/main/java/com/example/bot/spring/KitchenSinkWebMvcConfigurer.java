...
public class KitchenSinkWebMvcConfigurer implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        log.info("Add log dir : {}", KitchenSinkApplication.IMAGE_DIR);
        registry.addResourceHandler("/img/**").addResourceLocations("file:///C:/gitdir/line-bot-sdk-java/sample-spring-boot-kitchensink/src/main/resources/img/");
        log.info("Done add log dir : {}", KitchenSinkApplication.IMAGE_DIR);
